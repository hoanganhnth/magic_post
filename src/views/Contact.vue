...
<template>
    ...
    <div class="address">
        <div class="address-contact-item">
            ...
            <div class="company-name-contact">Trụ sở chính</div>
            <ul class="list-address">
                <li class="item-address">Tầng 4 , Toà nhà FLC Landmark Tower, ngõ 5 Lê Đức Thọ, Mỹ Đình 2, Nam Từ Liêm, Hà
                    Nội</li>
                <li class="item-address">Điện thoại: <a href="tel:1900545433">1900545433</a></li>
                <li class="item-address">Email: <a href="mailto:cskh@ems.com.vn">cskh@ems.com.vn</a></li>
            </ul>
        </div>
        <div class="address-contact-item">
            <div class="img-top-contact"><img
            ...
            <div class="company-name-contact">Chi nhánh Hà Nội</div>
            <ul class="list-address">
                <li class="item-address">Tầng 4 , Toà nhà FLC Landmark Tower, ngõ 5 Lê Đức Thọ, Mỹ Đình 2, Nam Từ Liêm, Hà
                    Nội</li>
                <li class="item-address">Điện thoại: <a href="tel:1900545433">1900545433</a></li>
        ...
        <div class="address-contact-item">
            ...
            <div class="company-name-contact">Chi nhánh Đà Nẵng</div>
            <ul class="list-address">
                <li class="item-address">Tầng 4 , Toà nhà FLC Landmark Tower, ngõ 5 Lê Đức Thọ, Mỹ Đình 2, Nam Từ Liêm, Hà
                    Nội</li>
                <li class="item-address">Điện thoại: <a href="tel:1900545433">1900545433</a></li>
        ...
        <div class="address-contact-item">
            ...
            <div class="company-name-contact">Chi nhánh Hồ Chí Minh</div>
            <ul class="list-address">
                <li class="item-address">Tầng 4 , Toà nhà FLC Landmark Tower, ngõ 5 Lê Đức Thọ, Mỹ Đình 2, Nam Từ Liêm, Hà
                    Nội</li>
                <li class="item-address">Điện thoại: <a href="tel:1900545433">1900545433</a></li>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-12">
            <div class="contact__right-form">
                <div class="contact__right-form-title"><img class="contact__right-form-title-icon"
                ...
                <form class="form-contact" siq_id="autopick_2474">
                    <div class="form-group"><input type="text" required="" placeholder="Tên của bạn" name="name" value=""
                            autocomplete="off" class="input-custom form-control form-control-lg"></div>
                    <div class="form-group"><input type="email" required="" placeholder="Email của bạn" name="email"
                            value="" autocomplete="off" class="input-custom form-control form-control-lg"></div>
                    <div class="form-group"><textarea required="" placeholder="Tin nhắn" name="content" autocomplete="off"
                            class="input-custom area form-control form-control-lg"></textarea></div><button
...
.address {
    ...
    margin-left: 10%;
    margin-right: 10%;
    /* Để các phần tử trên dòng mới khi không đủ không gian */
}
